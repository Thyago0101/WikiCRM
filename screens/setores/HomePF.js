...
export default function HomePF({navigation, route}) {
  ...
  console.log("HomePF.js - UserName: " + nomeDoUsuario)
  ...
  // Consulta os blocos do BD e atribui à variável blocos
   consultaBlocosBD = async () => {
      ...
      const blocosFiltrados = consultaBlocos.filter(bloco => bloco.setor === "registroPF")
