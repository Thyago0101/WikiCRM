...
export default function HomeTesouraria({navigation, route}) {
  ...
  // Consulta os blocos do BD e atribui à variável blocos
   consultaBlocosBD = async () => {
      ...
      const blocosFiltrados = consultaBlocos.filter(bloco => bloco.setor === "tesouraria")
